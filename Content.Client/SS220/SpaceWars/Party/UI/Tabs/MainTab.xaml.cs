...
public sealed partial class MainTab : Control
{
    ...
    public void UpdateMembers()
    {
        ...
        foreach (var user in _currentParty.Members)
        {
            ...
            info ??= GeneratePartyUserInfo(user);
    ...
    public PartyUserInfo GeneratePartyUserInfo(PartyUser member)
    {
        var control = new PartyUserInfo(member);
        control.Margin = new Thickness(5, 5, 5, 5);
        control.SetNewSize(new System.Numerics.Vector2(MembersContainer.Size.X - 10, 50));
        return control;
    }
