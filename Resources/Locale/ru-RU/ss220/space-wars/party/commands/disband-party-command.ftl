cmd-disband-party-desc = Расформировывает пати
cmd-disband-party-help = Использование: party:disband <id пати>

cmd-disband-party-invalid-arguments-count = Неверное число аргументов!\n{ $help }
